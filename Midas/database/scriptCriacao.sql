...
CREATE TABLE leilao (
    ...
    -- Garante que um produto só possa possuir um leilão.
...
CREATE TABLE produto_loja (
    ...
    CONSTRAINT uq_nome_produto_loja
        UNIQUE(nome)
);
...
CREATE TABLE pedido_item (
    ...
    -- Cada item representa OU um produto da loja
    -- OU um item de leilão.
...
CREATE TABLE pagamento (
    ...
    -- Não armazenar cartão, CVV ou senha.
...
CREATE INDEX idx_produto_estado_fisico
    ON produto(id_estado_fisico);


CREATE INDEX idx_produto_raridade
    ON produto(id_raridade);


CREATE INDEX idx_produto_imagem_produto
    ON produto_imagem(id_produto);
